...
// Test checking notification and result correctness
...
// Test checking learn setter and result correctness
BOOST_AUTO_TEST_CASE(LearnSetTrue) {
  //initialization
  Tools::Judge* new_judge = new Tools::Tester(2, 2);
  shared_ptr<Tools::Judge> judge_ptr(new_judge);
  Base::JudgeCollector judge_collector(judge_ptr);
  judge_collector.SetLearnMode(true);
...
// Test checking learn setter and result correctness
BOOST_AUTO_TEST_CASE(LearnSetFalse) {
  //initialization
  Tools::Judge* new_judge = new Tools::Tester(2, 2);
  shared_ptr<Tools::Judge> judge_ptr(new_judge);
  Base::JudgeCollector judge_collector(judge_ptr);
  judge_collector.SetLearnMode(false);
