...
BOOST_AUTO_TEST_CASE(DataCollector_ReadInputLine) {
  ...
  //test
  Base::DataProvider::DataInputLine input_line = data_collector.ReadInputLine();
...
BOOST_AUTO_TEST_CASE(DataCollector_ReadInputLines) {
  ...
  //test
  vector<Base::DataProvider::DataInputLine> input_lines = data_collector.ReadInputLines(2);

  Base::DataProvider::DataInputLine input_line = input_lines.front();
